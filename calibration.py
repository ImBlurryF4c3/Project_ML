...
def scores_calibration(D, L, filename, title):    ##### SCORE CALIBRATION
    ...
    if filename == 'SVM':
        Dz = utility.Znormalization(D) # per z-normalization
        D = Dz
    ...
    for ip in p:
        ...
        mact = evaluation.compute_actual_DCF(scores, orderedLabels, ip, 1, 1)
    ...
    for pi in priors:
        ...
        mact = evaluation.compute_actual_DCF(scores, orderedLabels, pi, 1, 1)
